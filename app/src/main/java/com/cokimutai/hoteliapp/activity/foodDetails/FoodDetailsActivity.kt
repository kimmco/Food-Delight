package com.cokimutai.hoteliapp.activity.foodDetails
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            DetialScreen(
                item = item,
                onBackClick = { finish() },
                onAddToCartClick = { managementCart.insertItem(item) }
            )
        }
...
@Composable
private fun DetialScreen(item: FoodModel, onBackClick: () -> Unit, onAddToCartClick: () -> Unit) {
